...
<template>
	<div class="flex flex-col gap-6">
		<header class="flex items-start justify-between">
			...
			<span class="text-sm text-muted-foreground mt-0.5 whitespace-nowrap shrink-0">
			...
			>
				...
				>
					...
					<div
						...
						class="mt-3 grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-3 items-start"
					>
						<template
						...
						>
							<div class="flex flex-col gap-1.5">
								...
								<div v-if="param.type === 'boolean'" class="h-8 flex items-center">
									<Switch
									:model-value="
								...
								<Select
									...
									"
								>
									<SelectTrigger size="sm" class="w-full h-8">
										<SelectValue />
									</SelectTrigger>
									<SelectContent>
										<SelectItem
